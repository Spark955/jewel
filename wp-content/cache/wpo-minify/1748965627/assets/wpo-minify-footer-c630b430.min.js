...
wp.i18n.setLocaleData( { 'text direction\u0004ltr': [ 'ltr' ] } );
wp.apiFetch.use( wp.apiFetch.createRootURLMiddleware( "https://oberonjewels.com/wp-json/" ) );
wp.apiFetch.nonceMiddleware = wp.apiFetch.createNonceMiddleware( "d710a3347a" );
wp.apiFetch.use( wp.apiFetch.nonceMiddleware );
wp.apiFetch.use( wp.apiFetch.mediaUploadMiddleware );
wp.apiFetch.nonceEndpoint = "https://oberonjewels.com/wp-admin/admin-ajax.php?action=rest-nonce";
...
jQuery(document).ready(function($){"use strict";$('p:empty').remove();AOS.init({once:!0,});$('[data-aos]').parent().addClass('hideOverflowOnMobile');window.lazySizesConfig=window.lazySizesConfig||{};lazySizesConfig.loadMode=2;lazySizesConfig.preloadAfterLoad=!1;$('img').addClass('lazyload');$("img.lazyload").each(function(){var srcValue=$(this).attr('src');$(this).attr('data-src',srcValue);var src=srcValue.replace(/\.\w+$/i,"");$(this).attr("src","data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==")});jQuery('html').removeClass('overflow-hidden');jQuery('html').addClass("page-loaded");jQuery(".loader-wrapper").fadeOut("slow",function(){jQuery(".content").fadeIn("slow");jQuery('html').removeClass("page-loaded")});$("#home-page-banner-slider").slick({dots:!0,arrows:!1,slidesToShow:1,slidesToScroll:1,infinite:!0,autoplay:!0,speed:800,autoplaySpeed:3000,fade:!0,cssEase:'ease',prevArrow:"<button type='button' class='slick-prev pull-left'></button>",nextArrow:"<button type='button' class='slick-next pull-right'></button>",responsive:[{breakpoint:1024,},{breakpoint:992,},{breakpoint:600,},],});$("#perfect-jewel-slider").slick({dots:!1,arrows:!0,slidesToShow:1,slidesToScroll:1,infinite:!0,fade:!0,cssEase:'ease',prevArrow:"<button type='button' class='slick-prev pull-left'></button>",nextArrow:"<button type='button' class='slick-next pull-right'></button>",responsive:[{breakpoint:1024,},{breakpoint:992,},{breakpoint:600,},],});$("#heritage_slider").slick({slidesToShow:5,slidesToScroll:1,infinite:!0,cssEase:'ease',autoplay:!0,speed:500,autoplaySpeed:2000,dots:!1,arrows:!1,responsive:[{breakpoint:1200,settings:{slidesToShow:4,},},{breakpoint:769,settings:{slidesToShow:3,},},{breakpoint:600,settings:{slidesToShow:2,},},{breakpoint:400,settings:{slidesToShow:1,},},],});$("#collection-slider").slick({dots:!1,arrows:!0,slidesToShow:3,slidesToScroll:1,infinite:!0,autoplay:!0,speed:500,autoplaySpeed:3000,cssEase:'ease',centerMode:!0,centerPadding:'0px',prevArrow:"<button type='button' class='slick-prev pull-left'></button>",nextArrow:"<button type='button' class='slick-next pull-right'></button>",responsive:[{breakpoint:1024,},{breakpoint:992,},{breakpoint:600,settings:{slidesToShow:1,centerPadding:'80px',},},{breakpoint:400,settings:{slidesToShow:1,centerPadding:'50px',},},],});$("#clients-slider").slick({dots:!1,arrows:!1,slidesToShow:1,slidesToScroll:1,infinite:!0,fade:!0,responsive:[{breakpoint:1024,},{breakpoint:992,},{breakpoint:600,},{breakpoint:400,},],});$(".clients-prev-btn").click(function(){$("#clients-slider").slick("slickPrev")});$(".clients-next-btn").click(function(){$("#clients-slider").slick("slickNext")})});
...
jQuery(document).ready(function($){function checkWidth(){if($(window).width()<=767){$('body').addClass('show-wpfFilter-sidebar')}else{$('body').removeClass('show-wpfFilter-sidebar')}}
checkWidth();$(window).resize(function(){checkWidth()});$('#category-filter-button').on('click',function(){$('body').addClass('open');if($('.wpfFilter-background').length===0){$('body').append('<div class="wpfFilter-background"></div>')}});$('#category-filter-close-button').on('click',function(){$('body').removeClass('open')});$(document).on('click',function(event){if(!$(event.target).closest('#category-filter-button, #category-filter-sidebar').length){$('body').removeClass('open')}});$(document).on('keydown',function(event){if(event.key==='Escape'){$('body').removeClass('open')}});$('.nav-tabs-home-wrapper').on('click','button',function(e){e.preventDefault();$('.home-product-tab-slider').slick('refresh')});$(".home-product-tab-slider").slick({slidesToShow:4.8,slidesToScroll:1,infinite:!1,cssEase:'ease',speed:500,autoplaySpeed:2000,dots:!1,arrows:!1,responsive:[{breakpoint:1500,settings:{slidesToShow:4,},},{breakpoint:1200,settings:{slidesToShow:3,},},{breakpoint:769,settings:{slidesToShow:3,},},{breakpoint:600,settings:{slidesToShow:2,},},{breakpoint:500,settings:{slidesToShow:1,},},],});$('.product-variations-color .variation-color').hover(function(){console.log('hoverd');var newImageUrl=$(this).data('image-url');var product=$(this).closest('.product');var productImage=product.find('.woocommerce-LoopProduct-link img');if(productImage.length){productImage.attr('src',newImageUrl);productImage.attr('srcset',newImageUrl);productImage.attr('sizes','(max-width: 300px) 100vw, 300px')}},function(){var product=$(this).closest('.product');var originalImage=product.data('original-image');var originalSrcset=product.data('original-srcset');var originalSizes=product.data('original-sizes');var productImage=product.find('.woocommerce-LoopProduct-link img');if(productImage.length){productImage.attr('src',originalImage);productImage.attr('srcset',originalSrcset);productImage.attr('sizes',originalSizes)}});$('.share-button').on('click',function(e){e.preventDefault();$('.social-icons').toggle()});function toggleReviewsTab(){if($('.reviews_tab_tab').hasClass('active')){$('#comments, #respond').show()}else{$('#comments, #respond').hide()}}
toggleReviewsTab();$('.woocommerce-tabs .tabs a').on('click',function(){setTimeout(toggleReviewsTab,100)});$('.flex-control-thumbs img').hover(function(){var largeImageUrl=$(this).attr('srcset').split(',')[0].split(' ')[0];var mainImage=$('.woocommerce-main-image img');mainImage.attr('src',largeImageUrl);mainImage.attr('srcset',$(this).attr('srcset'));mainImage.attr('sizes',$(this).attr('sizes'));mainImage.attr('data-large_image',largeImageUrl)})});jQuery(document).ready(function($){$('.woocommerce-LoopProduct-link').hover(function(){var mainImage=$(this).find('img.attachment-woocommerce_thumbnail');var firstGalleryImage=$(this).find('.hover-gallery-image').first();if(firstGalleryImage.length>0){firstGalleryImage.css({opacity:0});mainImage.css('opacity',0);firstGalleryImage.css('opacity',1).show()}else{}},function(){var mainImage=$(this).find('img.attachment-woocommerce_thumbnail');var firstGalleryImage=$(this).find('.hover-gallery-image').first();if(firstGalleryImage.length>0){firstGalleryImage.css('opacity',0);mainImage.css('opacity',1)}})});(function($){function woocommerceQuantity(){if(!String.prototype.getDecimals){String.prototype.getDecimals=function(){var num=this,match=(''+num).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);if(!match){return 0}
return Math.max(0,(match[1]?match[1].length:0)-(match[2]?+match[2]:0))}}
$(document).on('click','.plus, .minus',function(){$("button[name=\'update_cart\']").prop("disabled",!1);var $this=$(this),$qty=$this.closest('.quantity').find('.qty'),currentVal=parseFloat($qty.val()),max=parseFloat($qty.attr('max')),min=parseFloat($qty.attr('min')),step=$qty.attr('step');if(!currentVal||currentVal===''||currentVal==='NaN'){currentVal=0}
if(max===''||max==='NaN'){max=''}
if(min===''||min==='NaN'){min=0}
if(step==='any'||step===''||step===undefined||parseFloat(step)=='NaN'){step='1'}
if($this.is('.plus')){if(max&&(currentVal>=max)){$qty.val(max)}else{$qty.val((currentVal+parseFloat(step)).toFixed(step.getDecimals()))}}else{if(min&&(currentVal<=min)){$qty.val(min)}else if(currentVal>0){$qty.val((currentVal-parseFloat(step)).toFixed(step.getDecimals()))}}
$qty.closest('form.cart').submit()})}
$(document).ready(function(){woocommerceQuantity()})})(jQuery);jQuery(document).ready(function($){function updateCart(cart_item_key,quantity){$.ajax({type:'POST',url:wc_add_to_cart_params.ajax_url,data:{action:'update_cart_item',cart_item_key:cart_item_key,quantity:quantity},success:function(response){if(response.subtotal){$('#cart-subtotal').html(response.subtotal)}
if(response.cart_hash){$('body').trigger('wc_fragments_refreshed')}
checkIfCartIsEmpty()},error:function(xhr,status,error){console.log('Error:',error)}})}
function removeCartItem(cart_item_key){$.ajax({type:'POST',url:wc_add_to_cart_params.ajax_url,data:{action:'remove_cart_item',cart_item_key:cart_item_key},success:function(response){if(response.subtotal){$('#cart-subtotal').html(response.subtotal)}
if(response.cart_hash){$('body').trigger('wc_fragments_refreshed')}
$('button[data-cart-item-key="'+cart_item_key+'"]').closest('.cart-item').remove();checkIfCartIsEmpty()},error:function(xhr,status,error){console.log('Error:',error)}})}
function checkIfCartIsEmpty(){if($('.cart-item').length===0){$('.cart-offcanvas-body').html('<p class="empty-cart-message">You have no items in your shopping cart</p>')}}
$('.cart-offcanvas-body').on('click','.increase, .decrease',function(){var $input=$(this).siblings('input[type="number"]');var quantity=parseInt($input.val());var cart_item_key=$(this).data('cart-item-key');if($(this).hasClass('increase')){quantity++}else if($(this).hasClass('decrease')&&quantity>1){quantity--}
$input.val(quantity);updateCart(cart_item_key,quantity)});$('.cart-offcanvas-body').on('change','input[type="number"]',function(){var quantity=parseInt($(this).val());var cart_item_key=$(this).data('cart-item-key');if(quantity<1){quantity=1;$(this).val(1)}
updateCart(cart_item_key,quantity)});$('.cart-offcanvas-body').on('click','.remove-item',function(){var cart_item_key=$(this).data('cart-item-key');removeCartItem(cart_item_key)})});jQuery(window).on('load',function(){jQuery('.flex-control-thumbs').slick({infinite:!1,slidesToShow:4,slidesToScroll:1,vertical:!0,verticalSwiping:!0,dots:!1,arrows:!0,responsive:[{breakpoint:1200,settings:{vertical:!1,verticalSwiping:!1,slidesToShow:4,slidesToScroll:1},},{breakpoint:992,settings:{vertical:!1,verticalSwiping:!1,slidesToShow:3,},},{breakpoint:600,settings:{vertical:!1,verticalSwiping:!1,slidesToShow:3,},},{breakpoint:400,settings:{vertical:!1,verticalSwiping:!1,slidesToShow:3,},},]});jQuery('#commentform').on('submit',function(e){jQuery('.error-message').remove();var rating=jQuery('#rating').val();var comment=jQuery('#comment').val().trim();var isValid=!0;if(!rating||rating===''){jQuery('.comment-form-rating').append('<small class="error-message" style="color: red;">Rating is required.</small>');isValid=!1}
if(!comment){jQuery('.comment-form-comment').append('<small class="error-message" style="color: red;">Review is required.</small>');isValid=!1}
if(!isValid){e.preventDefault()}});jQuery('#rating, #comment').on('change input',function(){jQuery(this).closest('p').find('.error-message').remove()});jQuery('.stars a').on('click',function(e){e.preventDefault();var ratingValue=jQuery(this).attr('class').replace('star-','');jQuery('#rating').val(ratingValue);jQuery('.comment-form-rating .error-message').remove()});jQuery(".page-numbers a").each(function(){let pageNumber=jQuery(this).text().trim();if(jQuery.isNumeric(pageNumber)){let url=new URL(window.location.href);url.searchParams.set("product-page",pageNumber);jQuery(this).attr("href",url.toString())}})});
