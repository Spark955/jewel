...
jQuery(document).ready(function($){AOS.init();$('[data-aos]').parent().addClass('hideOverflowOnMobile');const $searchField=$('.search-field');const urlParams=new URLSearchParams(window.location.search);if(urlParams.has('s')){$searchField.val('')}});document.addEventListener('DOMContentLoaded',()=>{const target=document.querySelector('.plyr-video-player');if(!target)return;const observer=new IntersectionObserver((entries,observer)=>{entries.forEach(entry=>{if(entry.isIntersecting){const player=new Plyr(target,{controls:['play','progress','current-time','mute','autoplay','volume','settings','fullscreen'],disableContextMenu:!0,loop:{active:!0},autoplay:!0,muted:!0,youtube:{noCookie:!0,rel:0,showinfo:0,iv_load_policy:3,modestbranding:1}});player.on('ready',()=>{console.log('Plyr is ready and in view.')});observer.unobserve(target)}})},{threshold:0.3});observer.observe(target)});



jQuery(document).ready(function($){"use strict";var lastScrollTop=0;jQuery(window).scroll(function(){var scroll=jQuery(window).scrollTop();if(scroll<lastScrollTop&&scroll>=300){jQuery(".main-header").addClass("sticky-header")}else{jQuery(".main-header").removeClass("sticky-header")}
lastScrollTop=scroll});$('#navbar-toggler').on('click',function(){$('body').toggleClass("mobile-menu-active");$('.main-header').toggleClass("mobile-header")});$('#navbar-toggler-close').on('click',function(){$('body').removeClass("mobile-menu-active");$('.main-header').removeClass("mobile-header")});$('.home.page-template .main-header .navbar .menu-item a').on('click',function(){$('body').removeClass("mobile-menu-active");$('.main-header').removeClass("mobile-header")});$('.menu-overlay').on('click',function(){$('body').removeClass("mobile-menu-active");$('.main-header').removeClass("mobile-header")});$(document).on('keydown',function(e){if(e.keyCode===27){$('body').removeClass("mobile-menu-active");$('.main-header').removeClass("mobile-header")}});$('.mega-dropdown .dropdown-menu').on('click',function(event){event.stopPropagation()});$('.menu-item-has-children').has('ul').prepend('<span class="submenu-toggle"/>');$(".menu-item-has-children .submenu-toggle").click(function(event){event.preventDefault();jQuery(this).parent().find('ul').first().toggleClass('show');jQuery(this).parent().siblings().find('ul').removeClass('show')});jQuery("#bottom-top").hide();jQuery(window).scroll(function(){if(jQuery(window).scrollTop()>200){jQuery("#bottom-top").fadeIn(500)}else{jQuery("#bottom-top").fadeOut(500)}});jQuery("#bottom-top").click(function(){jQuery('body,html').animate({scrollTop:0},1000);return!1})});
